...
<main class="pt-5 max-lg-5">
  ...
  <form class="border border-light p-5">
    ...
    <p class="h4 mb-4 text-left">Modifier mon mot de passe</p>

    <input class="form-control mb-4" id="defaultContactFormName" type="text" name="password" placeholder="Ancien mot de passe" required>
    <input class="form-control mb-4" id="defaultContactFormName" type="text" name="new-password" placeholder="Nouveau mot de passe" required>

    <input class="form-control mb-4" id="defaultContactFormName" type="text" placeholder="Confirmer mon nouveau mot de passe" required>
